...
class Classifier():
    ...
    def min_bounding_rectangle_test(self):
        ...
        polygon_points_list = self.get_points_list(polygon)

        polygon_x_coordinates = []
        polygon_y_coordinates = []

        for i in polygon_points_list:
        ...
        for i in self.input_points_list:
...
input_points = [Point("Point", input_coordinates[0], input_coordinates[1]) for i in input_coordinates]
